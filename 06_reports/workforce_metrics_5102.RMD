...
## Introduction
created to supplement the racial equity survey results...
...
Departments, and Office (BDOs). The desired result of the Data sub-Team's work is 
to create a workforce in which one's work and/or career outcomes are not predicted 
by one's race. This statement is informed by more detailed goals and objectives 
...
CRET model of change - normalize, organize and operationalize – is 
