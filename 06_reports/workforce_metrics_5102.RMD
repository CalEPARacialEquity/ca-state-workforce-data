...
In 2020, the United States Census Bureau conducted the Decennial Census, the primary purposes of which are congressional apportionment and state redistricting. The Decennial Census uses different survey methods than the ACS, so demographic data may not be directly comparable between the two. The ACS is primarily for demographics, which is the purpose of this report. Both have their own error associated with the data so it is not necessarily true that the Decennial Census would be a significantly more accurate representation of actual demographics than the ACS. For these reasons, we used the ACS to represent California’s demographics in 2020. ([Reference](https://www.census.gov/content/dam/Census/library/publications/2020/acs/acs_general_handbook_2020_ch09.pdf https://www.census.gov/programs-surveys/acs/about/acs-and-census.html))
