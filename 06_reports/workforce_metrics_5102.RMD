...
To edit the code, if you haven't already you will want to download R (the coding language) and RStudio (the software used to develop this tool). To download R, click here: <https://www.r-project.org/>. To download RStudio, click here: <https://www.rstudio.com/products/rstudio/>. If you have any questions about this code, please email Devan Burke at <devan.burke@waterboards.ca.gov>.
